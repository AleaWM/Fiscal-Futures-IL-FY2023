...
year_totals  %>%  
  ...
  kable_classic() %>%   
  add_footnote(c("Methodology has changed slightly since FY21 so totals may differ from past publications", "All changes documented in ___ document.","Values include State CURE dollars (SLFRF)"))
```
...
write.xlsx(dataset_names, file = 'summary_file_FY23_wTotals_Dec242023.xlsx')
```
