# Calculating the Fiscal Gap {#sec-all-code-rounded}
...
write_csv(rev_temp, "data/rev_fy23_recoded_02April2024.csv")
...
year_totals %>% mutate_all(., ~round(., digits = 0))

write_csv(aggregated_totals_long, "data/aggregated_totals.csv")
