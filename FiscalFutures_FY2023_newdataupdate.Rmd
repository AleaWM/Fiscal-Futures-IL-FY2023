...
For 2023, there were no reused funds and only a couple new funds. 
...
funds_ab_in_2023 = readxl::read_excel("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/Fiscal Futures FY2023/funds_ab_in_2023.xlsx") 
...
ioc_source_type <- readxl::read_xlsx("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/Fiscal Futures FY2023/ioc_source_updated23_AWM.xlsx")
...
# Overall Fiscal Health & Complex Fiscal Topics {.tabset .tabset-pills}
...
```{r healthcare-employer-contributions, error=TRUE, fig.show='hold', out.width="50%"}
...
```{r healthcare-employer-contributions2, error=TRUE, fig.show='hold', out.width="50%"}
...
```{r healthcare-employer-contributions3, error=TRUE}
...
# Expenditure & Revenue Categorization {.tabset .tabset-pills}
...
__Changes in Categories - 2021 to 2022__:
...
write.xlsx(dataset_names, file = 'summary_file_FY23_wTotals_July26.xlsx')
```
